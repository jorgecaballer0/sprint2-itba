...
const Inicio = () =>{
    return(
        <>
        <h1 className="flex justify-center font-bold text-4xl text-blue-600 ">Hola,user!</h1>
    <div className="flex justify-center">
      ...
      <div className="bg-orange-400 w-80 m-10 rounded-lg text-xl text-orange-900">
        ...
        <button className="text-orange-900 text-center ml-40 ">Ver tarjeta</button>
      </div>
      </div>
    <div className="flex justify-center">
      <div className="w-80"><img src={BannerA} alt="" /></div>
       <div className="w-80 items-center"><img src={Banner} alt="" /></div> 
       <div className="w-80"><img src={BannerB} alt="" /></div> 
